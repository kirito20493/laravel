                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-bar-chart-o"></i> Quản lý <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('show-list-user')}}">Quản lý User</a>
                                        </li>
                                        <li><a href="{{route('show-list-product')}}">Quản lý hàng hoá</a>
                                        </li>
                                        <li><a href="{{route('show-list-catagory')}}">Quản lý Catalog</a>
                                        </li>
                                ...
                                <li><a><i class="fa fa-user"></i>Tài khoản<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('edit-user')}}">Đổi mật khẩu</a>
                                        </li>
